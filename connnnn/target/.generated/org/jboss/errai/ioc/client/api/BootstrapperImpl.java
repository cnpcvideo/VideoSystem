...
import org.cnpc.assistancesystems.client.local.App;
import javax.enterprise.event.Event;
import org.jboss.errai.ioc.client.InterfaceInjectionContext;
import org.jboss.errai.ioc.client.api.BootstrapperImpl;
import java.lang.annotation.Annotation;
import org.cnpc.assistancesystems.client.shared.MessageEvent;
import org.jboss.errai.ioc.client.api.builtin.MessageBusProvider;
import org.jboss.errai.enterprise.client.cdi.AbstractCDIEventCallback;
import org.jboss.errai.bus.client.api.Message;
import java.util.Set;
import org.jboss.errai.enterprise.client.cdi.CDIProtocol;
import org.cnpc.assistancesystems.client.shared.ResponseEvent;
...
public class BootstrapperImpl implements Bootstrapper {
    ...
    private native static void org_cnpc_assistancesystems_client_local_App_messageEvent(App instance, Event value) /*-{
        instance.@org.cnpc.assistancesystems.client.local.App::messageEvent = value;
    }-*/;

    private native static Event org_cnpc_assistancesystems_client_local_App_messageEvent(App instance) /*-{
        return instance.@org.cnpc.assistancesystems.client.local.App::messageEvent;
    }-*/;
    ...
    public InterfaceInjectionContext bootstrapContainer() {
        ...
        BootstrapperImpl.org_cnpc_assistancesystems_client_local_App_messageEvent(inj18, (inj3).get());
        final MessageBusProvider inj15 = new MessageBusProvider();
        ((inj15).get()).subscribe("cdi.event:org.cnpc.assistancesystems.client.shared.ResponseEvent", new AbstractCDIEventCallback() {
